...
async def upslope_gait(front_left_leg, front_right_leg, back_left_leg, back_right_leg):
  ...
  await wait_for_user()
  await rotate_servo(front_right_leg.hip_location, front_right_leg.hip_min-front_right_leg.hip_neutral, 3) #!!! wrong way
  await wait_for_user()
  ...
  await wait_for_user()
  await rotate_servo(front_left_leg.hip_location, front_left_leg.hip_neutral-front_left_leg.hip_min, 2)
  await wait_for_user()
