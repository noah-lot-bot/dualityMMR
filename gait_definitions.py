...
async def upslope_gait(front_left_leg, front_right_leg, back_left_leg, back_right_leg):
  ...
  await wait_for_user()
  await rotate_servo(front_right_leg.hip_location, front_right_leg.hip_neutral-front_right_leg.hip_max, 3) #!!!
  await wait_for_user()
  ...
  await set_wheel_speed(front_right_leg.wheel_location, 0.5)
  await wait_for_user()
  await rotate_servo(front_right_leg.hip_location, front_right_leg.hip_max-front_right_leg.hip_neutral, 3) #!!!
  await wait_for_user()
  await set_wheel_speed(front_right_leg.wheel_location, 0.1)
  await wait_for_user()
  ...
  await set_wheel_speed(back_left_leg.wheel_location, -0.5)
  await wait_for_user()
  await rotate_servo(back_left_leg.hip_location, back_left_leg.hip_neutral-back_right_leg.hip_max, 3) #!!!
  await wait_for_user()
  await set_wheel_speed(back_left_leg.wheel_location, 0.1)
  await wait_for_user()
  ...
  await wait_for_user()
  await rotate_servo(back_right_leg.hip_location, back_right_leg.hip_neutral-back_right_leg.hip_max, 2) #!!!
  await wait_for_user()
  ...
  await set_wheel_speed(back_left_leg.wheel_location, 0.5)
  await wait_for_user()
  await rotate_servo(back_left_leg.hip_location, back_right_leg.hip_min-back_right_leg.hip_neutral, 3) #!!!
  await wait_for_user()
  await set_wheel_speed(back_left_leg.wheel_location, 0.1)
  await wait_for_user()
  ...
  await rotate_servo(front_right_leg.knee_location, front_right_leg.knee_neutral-front_right_leg.knee_max, 2) #!!!
  await wait_for_user()
  await rotate_servo(front_right_leg.hip_location, front_right_leg.hip_neutral-front_right_leg.hip_max, 2) #!!!
  await wait_for_user()
